...
class operate_email:
    ...
    def send_email_by_smtp(self):
        # 用于发送邮件的邮箱。修改成自己的邮箱
        sender_email_address = "741470468@qq.com"
        # 用于发送邮件的邮箱的密码。修改成自己的邮箱的密码
        sender_email_password = "rwpykgkpgidnbcgd"
        ...
        # 要发往的邮箱
        receiver_email = "513881538@qq.com"
        # 要发送的邮件主题
    ...
    def recv_email_by_pop3(self):
        # 要进行邮件接收的邮箱。改成自己的邮箱
        email_address = "513881538@qq.com"
        # 要进行邮件接收的邮箱的密码。改成自己的邮箱的密码
        email_password = "13329906178"
